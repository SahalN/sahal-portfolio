...
export const dictionary = {
  en: {
    ...
    "home.experience.role": "Full-Stack Developer",
    "home.experience.period": "2025 — Present",
    "home.experience.body":
      "Building and maintaining web applications end to end, from database schema and API design through to the interfaces people actually use.",

    "home.certs.title": "Certifications",
    "home.certs.all": "View all certificates",

    "certs.title": "Certifications",
    "certs.intro":
      "Courses and programs I have completed, grouped by the institution that issued them. Each entry links to its verifiable credential.",
    "certs.credential": "View credential",
    "certs.empty": "Nothing here yet.",

    "home.bio.title": "Bio",
    "home.bio.born": "Born in Jakarta, Indonesia.",
    "home.bio.enrolled":
      "Started a Computer Science degree at Gunadarma University.",
    "home.bio.bangkit":
      "Apprenticeship at Bangkit Academy, led by Google, GoTo, and Traveloka.",
    "home.bio.degree":
    ...
    "home.recent.all": "View all projects →",
    ...
    "home.contact.direct": "Prefer not to use the form? Reach me directly:",
    ...
    "footer.views.one": "visitor",
    "footer.views.other": "visitors",
  },
  ...
  id: {
    ...
    "home.stack.title": "Teknologi",

    "home.experience.title": "Pengalaman",
    "home.experience.role": "Full-Stack Developer",
    "home.experience.period": "2025 — Sekarang",
    "home.experience.body":
      "Membangun dan merawat aplikasi web dari hulu ke hilir, mulai dari skema basis data dan perancangan API hingga antarmuka yang dipakai penggunanya.",

    "home.certs.title": "Sertifikasi",
    "home.certs.all": "Lihat semua sertifikat",

    "certs.title": "Sertifikasi",
    "certs.intro":
      "Kelas dan program yang telah saya selesaikan, dikelompokkan berdasarkan lembaga penerbitnya. Setiap entri tertaut ke kredensial yang dapat diverifikasi.",
    "certs.credential": "Lihat kredensial",
    "certs.empty": "Belum ada isinya.",

    "home.bio.title": "Biodata",
    "home.bio.born": "Lahir di Jakarta, Indonesia.",
    "home.bio.enrolled":
      "Mulai kuliah Ilmu Komputer di Universitas Gunadarma.",
    "home.bio.bangkit":
      "Apprenticeship di Bangkit Academy, program dari Google, GoTo, dan Traveloka.",
    "home.bio.degree":
    ...
    "home.recent.all": "Lihat semua proyek →",
    ...
    "home.contact.direct":
      "Tidak ingin memakai formulir? Hubungi saya langsung:",
    ...
    // Indonesian does not inflect for number: both forms are identical.
    "footer.views.one": "pengunjung",
    "footer.views.other": "pengunjung",
  },
};

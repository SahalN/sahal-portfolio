    ...
    <>
      ...
      <Transition>
        <div className='flex flex-row items-center justify-center my-32 md:flex-col'>
          ...
          <div>
            <h1 className='py-3 text-6xl font-bold dark:text-white'>
              What I do
            </h1>
          </div>
          <div>
      ...
      <Transition>
        <div className='grid grid-cols-3 my-32 gap-36'>
          ...
          <div className='text-center justify-self-center'>
            ...
            <div>
              <p className='text-gray-500 dark:text-gray-100'>
                I specialize in creating responsive and intuitive mobile apps
                that work seamlessly across iOS & Android devices. From concept
                to deployment, I handle every stage of the development process.
              </p>
            </div>
          </div>
          <div className='text-center justify-self-center'>
          ...
          <div className='text-center justify-self-center'>
            ...
            <div>
              <p className='text-gray-500 dark:text-gray-100'>
                ...
                ensuring your users enjoy a fast and responsive experience,
                which in turn boosts user satisfaction and SEO rankings.
              </p>
            </div>
          </div>
          <div className='text-center justify-self-center'>
            ...
            <div>
              <p className='text-gray-500 dark:text-gray-100'>
                My development goes hand-in-hand with an eye for design. I
                create user interfaces that are not only functional but also
      ...
      <Transition>
        ...
        <div className='flex flex-row items-center gap-3 my-32 md:flex-col'>
          ...
          <div className='flex justify-between gap-36'>
            <div className='max-w-sm transition duration-300 ease-in-out delay-150 bg-white border border-gray-200 rounded-lg shadow hover:-translate-y-1 hover:scale-110 dark:bg-gray-800 dark:border-gray-700'>
